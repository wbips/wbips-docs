...
The `getAddresses` method is called to obtain an on-chain address from the wallet.
...
<Callout type="info" emoji="ℹ️">
  WebLN implementations might choose to implement this method when exposing
  access to the on-chain wallet.
</Callout>
...
- Array - An array of bitcoin address objects <span class="badge">Required</span>
